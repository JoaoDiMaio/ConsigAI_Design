export const financialSummary = {
  ...
  salaryAfter: 'R$ 2.121',
  salaryGain: 'R$ 471 de salário líquido',
...
export const statusMap = {
  ...
  recusada: { label: 'Não aceita', bg: '#FFF1F1', color: '#B32727', border: '#F2C2C2' },
  andamento: { label: 'Em andamento', bg: '#EEF4FF', color: '#2454D6', border: '#C7D9FF' },
  concluida: { label: 'Concluída', bg: '#F0FFF8', color: '#007A52', border: '#BDECD7' },
...
export const summaryCardDefs = [
  ...
  { title: 'Propostas não aceitas', status: 'recusada' },
  { title: 'Operações em andamento', status: 'andamento' },
  { title: 'Contratos concluídos', status: 'concluida' },
]
...
export const proposals = [
  {
    ...
    note: 'O banco de origem tentou manter o contrato. A oferta final mudou depois da resposta dele.',
    progress: [
      { label: 'Proposta enviada', done: true },
      { label: 'Análise da margem', done: true },
      { label: 'Retenção aplicada', done: true },
  ...
  },
  {
    ...
    note: 'Oferta mantida sem alterações. Contrato assinado e valor creditado.',
    progress: [
      { label: 'Proposta enviada', done: true },
      { label: 'Aprovação de crédito', done: true },
  ...
  },
  {
    ...
    note: 'Aguardando assinatura eletrônica para concluir a liberação do valor.',
    progress: [
      { label: 'Proposta enviada', done: true },
      { label: 'Aprovação de crédito', done: true },
