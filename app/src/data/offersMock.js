...
export const OFFER_CARD_CONFIG = [
  {
    ...
    state: {
      strategyType: 'dinheiro + economia total',
      offerLogic: 'valor_liberado + economia_total',
    },
    note: 'Receba dinheiro e reduza o custo total da sua dívida. A estratégia pode usar margem livre, refinanciamento, portabilidade ou combinação de contratos.',
  },
  {
    id: 'folga',
    kind: 'folga',
    ...
    route: '/estrategia-combinada',
    state: {
      strategyType: 'dinheiro + parcela menor',
      offerLogic: 'valor_liberado + reducao_mensal',
    },
    note: 'Receba dinheiro e diminua o peso da parcela no mês. Atenção: parcela menor pode envolver novo prazo e custo total maior.',
  },
  {
    id: 'turbo',
    kind: 'turbo',
